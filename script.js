...
const tempOveriew = fs.readFileSync(
  "/home/vonnue/Desktop/Siva/back-end/complete-node-bootcamp/1-node-farm/starter/templates/template-overview.html",
  "utf-8"
);
const tempcard = fs.readFileSync(
  "/home/vonnue/Desktop/Siva/back-end/complete-node-bootcamp/1-node-farm/starter/templates/template-card-html",
  "utf-8"
);
const tempProduct = fs.readFileSync(
  "/home/vonnue/Desktop/Siva/back-end/complete-node-bootcamp/1-node-farm/starter/templates/template-product.html",
  "utf-8"
);

const data = fs.readFileSync(
  "/home/vonnue/Desktop/Siva/back-end/complete-node-bootcamp/1-node-farm/starter/dev-data/data.json",
  "utf-8"
);
const dataObj = JSON.parse(data);
const emojiToId={
    "🥑": 0,  // Fresh Avocados
    "🧀": 1,  // Goat and Sheep Cheese
    "🥦": 2,  // Apollo Broccoli
    "🥕": 3,  // Baby Carrots
    "🌽": 4   // Sweet Corncobs
}
